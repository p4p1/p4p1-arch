...
function install_calamares() {
	...
	# Delete calameres lib that break pacman
	cat assets/delme | xargs -l -I {} sudo rm -rf {}
	echo -e "Nuked calamares dependencies that break install -> \e[36m:)\e[0m"
}
